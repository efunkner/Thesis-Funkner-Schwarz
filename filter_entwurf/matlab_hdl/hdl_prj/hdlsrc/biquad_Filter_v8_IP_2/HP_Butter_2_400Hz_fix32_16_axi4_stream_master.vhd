-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\HP_Butter_2_400Hz_fix32_16_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HP_Butter_2_400Hz_fix32_16_axi4_stream_master
-- Source Path: HP_Butter_2_400Hz_fix32_16/HP_Butter_2_400Hz_fix32_16_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HP_Butter_2_400Hz_fix32_16_axi4_stream_master IS
...
END HP_Butter_2_400Hz_fix32_16_axi4_stream_master;


ARCHITECTURE rtl OF HP_Butter_2_400Hz_fix32_16_axi4_stream_master IS

  -- Component Declarations
  COMPONENT HP_Butter_2_400Hz_fix32_16_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT HP_Butter_2_400Hz_fix32_16_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : HP_Butter_2_400Hz_fix32_16_fifo_data_OUT
    USE ENTITY work.HP_Butter_2_400Hz_fix32_16_fifo_data_OUT(rtl);

  FOR ALL : HP_Butter_2_400Hz_fix32_16_fifo_TLAST_OUT
    USE ENTITY work.HP_Butter_2_400Hz_fix32_16_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_HP_Butter_2_400Hz_fix32_16_fifo_data_OUT_inst : HP_Butter_2_400Hz_fix32_16_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_HP_Butter_2_400Hz_fix32_16_fifo_TLAST_OUT_inst : HP_Butter_2_400Hz_fix32_16_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
