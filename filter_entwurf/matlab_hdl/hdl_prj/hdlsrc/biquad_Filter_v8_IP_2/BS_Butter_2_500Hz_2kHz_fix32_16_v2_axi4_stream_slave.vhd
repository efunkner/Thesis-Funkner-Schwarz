-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_slave
-- Source Path: BS_Butter_2_500Hz_2kHz_fix32_16_v2/BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_slave IS
...
END BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_slave;


ARCHITECTURE rtl OF BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data
    USE ENTITY work.BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data(rtl);
...
BEGIN
  u_BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data_inst : BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
