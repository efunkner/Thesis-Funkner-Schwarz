-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BS_Butter_2_400Hz_4kHz_fix32_16_src_BiquadDF2Section1.vhd
-- Created: 2025-06-23 18:04:52
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BS_Butter_2_400Hz_4kHz_fix32_16_src_BiquadDF2Section1
...
ENTITY BS_Butter_2_400Hz_4kHz_fix32_16_src_BiquadDF2Section1 IS
...
END BS_Butter_2_400Hz_4kHz_fix32_16_src_BiquadDF2Section1;


ARCHITECTURE rtl OF BS_Butter_2_400Hz_4kHz_fix32_16_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  numProd1 <= to_signed(865865830, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-1707599604, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(865865830, 32) * numPrePipe3;
  ...
  denProd1 <= to_signed(1707599604, 32) * denOut;

  denProd2 <= to_signed(-657989836, 32) * denOut;
