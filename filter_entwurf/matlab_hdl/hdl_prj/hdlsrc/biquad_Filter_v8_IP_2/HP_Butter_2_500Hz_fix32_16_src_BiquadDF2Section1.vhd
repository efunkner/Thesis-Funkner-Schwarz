-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\HP_Butter_2_500Hz_fix32_16_src_BiquadDF2Section1.vhd
-- Created: 2025-06-23 17:12:36
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: HP_Butter_2_500Hz_fix32_16_src_BiquadDF2Section1
...
ENTITY HP_Butter_2_500Hz_fix32_16_src_BiquadDF2Section1 IS
...
END HP_Butter_2_500Hz_fix32_16_src_BiquadDF2Section1;


ARCHITECTURE rtl OF HP_Butter_2_500Hz_fix32_16_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  numProd1 <= to_signed(1025180809, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-2050361618, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(1025180809, 32) * numPrePipe3;
  ...
  denProd1 <= to_signed(2048164275, 32) * denOut;

  denProd2 <= to_signed(-978817138, 32) * denOut;
