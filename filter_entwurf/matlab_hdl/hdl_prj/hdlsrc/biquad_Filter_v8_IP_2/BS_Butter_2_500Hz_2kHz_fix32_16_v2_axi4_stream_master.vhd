-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_master
-- Source Path: BS_Butter_2_500Hz_2kHz_fix32_16_v2/BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_master IS
...
END BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_master;


ARCHITECTURE rtl OF BS_Butter_2_500Hz_2kHz_fix32_16_v2_axi4_stream_master IS

  -- Component Declarations
  COMPONENT BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data_OUT
    USE ENTITY work.BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data_OUT(rtl);

  FOR ALL : BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_TLAST_OUT
    USE ENTITY work.BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data_OUT_inst : BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_TLAST_OUT_inst : BS_Butter_2_500Hz_2kHz_fix32_16_v2_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
