-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BP_Butter_2_300Hz_3kHz_fix32_16.vhd
-- Created: 2025-06-23 17:58:02
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BP_Butter_2_300Hz_3kHz_fix32_16
-- Source Path: BP_Butter_2_300Hz_3kHz_fix32_16
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BP_Butter_2_300Hz_3kHz_fix32_16 IS
...
END BP_Butter_2_300Hz_3kHz_fix32_16;


ARCHITECTURE rtl OF BP_Butter_2_300Hz_3kHz_fix32_16 IS

  -- Component Declarations
  COMPONENT BP_Butter_2_300Hz_3kHz_fix32_16_reset_sync
  ...
  COMPONENT BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT BP_Butter_2_300Hz_3kHz_fix32_16_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BP_Butter_2_300Hz_3kHz_fix32_16_reset_sync
    USE ENTITY work.BP_Butter_2_300Hz_3kHz_fix32_16_reset_sync(rtl);

  FOR ALL : BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_slave
    USE ENTITY work.BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_slave(rtl);

  FOR ALL : BP_Butter_2_300Hz_3kHz_fix32_16_dut
    USE ENTITY work.BP_Butter_2_300Hz_3kHz_fix32_16_dut(rtl);

  FOR ALL : BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_master
    USE ENTITY work.BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_master(rtl);
...
BEGIN
  u_BP_Butter_2_300Hz_3kHz_fix32_16_reset_sync_inst : BP_Butter_2_300Hz_3kHz_fix32_16_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_slave_inst : BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_BP_Butter_2_300Hz_3kHz_fix32_16_dut_inst : BP_Butter_2_300Hz_3kHz_fix32_16_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_master_inst : BP_Butter_2_300Hz_3kHz_fix32_16_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
