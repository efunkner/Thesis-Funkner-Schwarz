-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\HP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
-- Source Path: HP_Butter_2_1kHz_fix32_16_v2/HP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave IS
...
END HP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave;


ARCHITECTURE rtl OF HP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT HP_Butter_2_1kHz_fix32_16_v2_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : HP_Butter_2_1kHz_fix32_16_v2_fifo_data
    USE ENTITY work.HP_Butter_2_1kHz_fix32_16_v2_fifo_data(rtl);
...
BEGIN
  u_HP_Butter_2_1kHz_fix32_16_v2_fifo_data_inst : HP_Butter_2_1kHz_fix32_16_v2_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
