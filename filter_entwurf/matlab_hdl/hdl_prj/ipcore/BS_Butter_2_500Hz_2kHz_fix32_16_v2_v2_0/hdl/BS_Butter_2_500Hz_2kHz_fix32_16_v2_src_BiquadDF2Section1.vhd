-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1.vhd
-- Created: 2025-06-26 16:09:51
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1
...
ENTITY BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1 IS
...
END BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1;


ARCHITECTURE rtl OF BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  numProd1 <= to_signed(977469483, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-1938160267, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(977469483, 32) * numPrePipe3;
  ...
  adder_add_cast <= resize(numPostPipe3, 66);
  ...
  adder_add_cast_2 <= resize(numPostPipe2, 66);
  ...
  adder_add_cast_4 <= resize(numPostPipe1, 66);
