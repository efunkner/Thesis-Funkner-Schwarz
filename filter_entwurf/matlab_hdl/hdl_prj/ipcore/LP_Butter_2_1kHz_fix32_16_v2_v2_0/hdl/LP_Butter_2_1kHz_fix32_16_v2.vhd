-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\LP_Butter_2_1kHz_fix32_16_v2.vhd
-- Created: 2025-06-26 16:36:00
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: LP_Butter_2_1kHz_fix32_16_v2
-- Source Path: LP_Butter_2_1kHz_fix32_16_v2
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LP_Butter_2_1kHz_fix32_16_v2 IS
...
END LP_Butter_2_1kHz_fix32_16_v2;


ARCHITECTURE rtl OF LP_Butter_2_1kHz_fix32_16_v2 IS

  -- Component Declarations
  COMPONENT LP_Butter_2_1kHz_fix32_16_v2_reset_sync
  ...
  COMPONENT LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT LP_Butter_2_1kHz_fix32_16_v2_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : LP_Butter_2_1kHz_fix32_16_v2_reset_sync
    USE ENTITY work.LP_Butter_2_1kHz_fix32_16_v2_reset_sync(rtl);

  FOR ALL : LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
    USE ENTITY work.LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave(rtl);

  FOR ALL : LP_Butter_2_1kHz_fix32_16_v2_dut
    USE ENTITY work.LP_Butter_2_1kHz_fix32_16_v2_dut(rtl);

  FOR ALL : LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_master
    USE ENTITY work.LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_master(rtl);
...
BEGIN
  u_LP_Butter_2_1kHz_fix32_16_v2_reset_sync_inst : LP_Butter_2_1kHz_fix32_16_v2_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave_inst : LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_LP_Butter_2_1kHz_fix32_16_v2_dut_inst : LP_Butter_2_1kHz_fix32_16_v2_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_master_inst : LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
