...
Zu beachten ist, dass nur 16-Bit-WAV-Dateien unterstütz werden. Die Datei kann jedoch Mono oder Stereo mit und eine beliebige Samplerate sein. Die WAV-Datei, die gefiltert werden soll muss zu `original.wav` umbenannt werden bevor diese auf die SD-karte übertragen wird.
