...
```
![Butterworth-Tiefpass](images/butter_tp.png)
...
b, a = cheby1(N = Order,
              ...
              analog = False)
```
![Chebychev Typ 1-Hochpass](images/cheby1_hp.png)
...
```
![Chebychev Typ 2-Bandpass](images/cheby2_bp.png)
...
sos = ellip(N = Order,
            ...
            output = 'sos')
```
![Elliptischer Bandstop](images/ellip_bp.png)
