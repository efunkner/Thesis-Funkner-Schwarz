...
Die `plot_wav.ipynb` dient zur Visualisierung des Frequenzsepktrums einer WAV-Datei<br>
<img src="https://github.com/efunkner/Thesis-Funkner-Schwarz/blob/main/images/plot_wav.png"><br>
