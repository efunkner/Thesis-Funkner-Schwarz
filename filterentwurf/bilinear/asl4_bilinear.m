...
xlim([0 4000]);
ylim([-30 15]);
legend(["Analoger Tiefpass" "Analoger Hochpass" "Analoger Bandpass" "Analoge Bandsperre" "Digitaler Tiefpass" "Digitaler Hochpass" "Digitaler Bandpass" "Digitale Bandsperre"]);
