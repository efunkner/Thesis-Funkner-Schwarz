...
HD_PWD='F:/VivadoDesign/Audio_duo_Filter_v2/Audio_duo_Filter_v2.runs/audio_test_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_test_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_test_xbar_2.tcl
