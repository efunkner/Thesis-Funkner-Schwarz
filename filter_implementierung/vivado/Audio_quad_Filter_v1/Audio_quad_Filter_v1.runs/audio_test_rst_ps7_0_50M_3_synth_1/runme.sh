...
HD_PWD='F:/VivadoDesign/Audio_duo_Filter_v1/Audio_duo_Filter_v1.runs/audio_test_rst_ps7_0_50M_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_test_rst_ps7_0_50M_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_test_rst_ps7_0_50M_3.tcl
