...
HD_PWD='F:/VivadoDesign/Audio_quad_Filter_v1/Audio_quad_Filter_v1.runs/audio_test_axi_dma_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_test_axi_dma_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_test_axi_dma_0_6.tcl
