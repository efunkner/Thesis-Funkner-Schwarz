...
HD_PWD='F:/VivadoDesign/audio_test_v2_2/audio_test_v2_2.runs/audio_test_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_test_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_test_proc_sys_reset_0_0.tcl
