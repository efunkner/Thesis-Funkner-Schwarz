-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v5_old_IP_test\BiquadFil_ip_2_1_src_Biquad_Filter.vhd
-- Created: 2025-05-23 14:20:58
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_2_1_src_Biquad_Filter
...
ENTITY BiquadFil_ip_2_1_src_Biquad_Filter IS
...
END BiquadFil_ip_2_1_src_Biquad_Filter;


ARCHITECTURE rtl OF BiquadFil_ip_2_1_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_2_1_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFil_ip_2_1_src_BiquadDF2Section1
    USE ENTITY work.BiquadFil_ip_2_1_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : BiquadFil_ip_2_1_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
