-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v5_old_IP_test\BiquadFil_ip_2_0_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_2_0_axi_lite
-- Source Path: BiquadFil_ip_2_0/BiquadFil_ip_2_0_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_2_0_axi_lite IS
...
END BiquadFil_ip_2_0_axi_lite;


ARCHITECTURE rtl OF BiquadFil_ip_2_0_axi_lite IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_2_0_addr_decoder
  ...
  COMPONENT BiquadFil_ip_2_0_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BiquadFil_ip_2_0_addr_decoder
    USE ENTITY work.BiquadFil_ip_2_0_addr_decoder(rtl);

  FOR ALL : BiquadFil_ip_2_0_axi_lite_module
    USE ENTITY work.BiquadFil_ip_2_0_axi_lite_module(rtl);
...
BEGIN
  u_BiquadFil_ip_2_0_addr_decoder_inst : BiquadFil_ip_2_0_addr_decoder
  ...
  u_BiquadFil_ip_2_0_axi_lite_module_inst : BiquadFil_ip_2_0_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
