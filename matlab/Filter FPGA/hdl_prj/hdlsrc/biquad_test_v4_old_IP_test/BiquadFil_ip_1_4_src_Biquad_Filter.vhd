-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_1_4_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_1_4_src_Biquad_Filter
...
ENTITY BiquadFil_ip_1_4_src_Biquad_Filter IS
...
END BiquadFil_ip_1_4_src_Biquad_Filter;


ARCHITECTURE rtl OF BiquadFil_ip_1_4_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_1_4_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_10_0                      :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFil_ip_1_4_src_BiquadDF2Section1
    USE ENTITY work.BiquadFil_ip_1_4_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : BiquadFil_ip_1_4_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
