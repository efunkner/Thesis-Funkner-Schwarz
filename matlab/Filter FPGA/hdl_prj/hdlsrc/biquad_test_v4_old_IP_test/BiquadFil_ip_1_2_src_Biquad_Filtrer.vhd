-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_1_2_src_Biquad_Filtrer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_1_2_src_Biquad_Filtrer
...
ENTITY BiquadFil_ip_1_2_src_Biquad_Filtrer IS
...
END BiquadFil_ip_1_2_src_Biquad_Filtrer;


ARCHITECTURE rtl OF BiquadFil_ip_1_2_src_Biquad_Filtrer IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_1_2_src_Biquad_Filter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BiquadFil_ip_1_2_src_Biquad_Filter
    USE ENTITY work.BiquadFil_ip_1_2_src_Biquad_Filter(rtl);
...
BEGIN
  u_Biquad_Filter : BiquadFil_ip_1_2_src_Biquad_Filter
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
