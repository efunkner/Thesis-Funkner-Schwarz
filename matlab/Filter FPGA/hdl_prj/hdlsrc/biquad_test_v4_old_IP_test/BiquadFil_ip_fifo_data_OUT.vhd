-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_fifo_data_OUT
-- Source Path: BiquadFil_ip/BiquadFil_ip_axi4_stream_master/BiquadFil_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_fifo_data_OUT IS
...
END BiquadFil_ip_fifo_data_OUT;


ARCHITECTURE rtl OF BiquadFil_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : BiquadFil_ip_SimpleDualPortRAM_generic
    USE ENTITY work.BiquadFil_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_BiquadFil_ip_fifo_data_OUT_classic_ram_generic : BiquadFil_ip_SimpleDualPortRAM_generic
