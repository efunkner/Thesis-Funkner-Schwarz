-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_1_5_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_1_5_axi4_stream_slave
-- Source Path: BiquadFil_ip_1_5/BiquadFil_ip_1_5_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_1_5_axi4_stream_slave IS
...
END BiquadFil_ip_1_5_axi4_stream_slave;


ARCHITECTURE rtl OF BiquadFil_ip_1_5_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_1_5_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BiquadFil_ip_1_5_fifo_data
    USE ENTITY work.BiquadFil_ip_1_5_fifo_data(rtl);
...
BEGIN
  u_BiquadFil_ip_1_5_fifo_data_inst : BiquadFil_ip_1_5_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
