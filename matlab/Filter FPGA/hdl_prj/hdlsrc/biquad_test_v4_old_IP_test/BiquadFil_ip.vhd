-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip.vhd
...
ARCHITECTURE rtl OF BiquadFil_ip IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_reset_sync
  ...
  COMPONENT BiquadFil_ip_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT BiquadFil_ip_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BiquadFil_ip_reset_sync
    USE ENTITY work.BiquadFil_ip_reset_sync(rtl);

  FOR ALL : BiquadFil_ip_axi4_stream_slave
    USE ENTITY work.BiquadFil_ip_axi4_stream_slave(rtl);

  FOR ALL : BiquadFil_ip_dut
    USE ENTITY work.BiquadFil_ip_dut(rtl);

  FOR ALL : BiquadFil_ip_axi4_stream_master
    USE ENTITY work.BiquadFil_ip_axi4_stream_master(rtl);
...
BEGIN
  u_BiquadFil_ip_reset_sync_inst : BiquadFil_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_BiquadFil_ip_axi4_stream_slave_inst : BiquadFil_ip_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_BiquadFil_ip_dut_inst : BiquadFil_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_BiquadFil_ip_axi4_stream_master_inst : BiquadFil_ip_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
