-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_1_7_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_1_7_axi4_stream_master
-- Source Path: BiquadFil_ip_1_7/BiquadFil_ip_1_7_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_1_7_axi4_stream_master IS
...
END BiquadFil_ip_1_7_axi4_stream_master;


ARCHITECTURE rtl OF BiquadFil_ip_1_7_axi4_stream_master IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_1_7_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BiquadFil_ip_1_7_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BiquadFil_ip_1_7_fifo_data_OUT
    USE ENTITY work.BiquadFil_ip_1_7_fifo_data_OUT(rtl);

  FOR ALL : BiquadFil_ip_1_7_fifo_TLAST_OUT
    USE ENTITY work.BiquadFil_ip_1_7_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_BiquadFil_ip_1_7_fifo_data_OUT_inst : BiquadFil_ip_1_7_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_BiquadFil_ip_1_7_fifo_TLAST_OUT_inst : BiquadFil_ip_1_7_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
