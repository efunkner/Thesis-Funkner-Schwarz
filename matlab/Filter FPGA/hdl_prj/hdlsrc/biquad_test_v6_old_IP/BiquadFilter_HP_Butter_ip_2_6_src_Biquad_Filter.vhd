-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter
...
ENTITY BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter IS
...
END BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter;


ARCHITECTURE rtl OF BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
