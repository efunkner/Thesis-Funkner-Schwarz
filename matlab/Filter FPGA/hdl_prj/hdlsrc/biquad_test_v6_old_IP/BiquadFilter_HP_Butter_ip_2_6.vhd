-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFilter_HP_Butter_ip_2_6.vhd
-- Created: 2025-06-04 12:22:32
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFilter_HP_Butter_ip_2_6
-- Source Path: BiquadFilter_HP_Butter_ip_2_6
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFilter_HP_Butter_ip_2_6 IS
...
END BiquadFilter_HP_Butter_ip_2_6;


ARCHITECTURE rtl OF BiquadFilter_HP_Butter_ip_2_6 IS

  -- Component Declarations
  COMPONENT BiquadFilter_HP_Butter_ip_2_6_reset_sync
  ...
  COMPONENT BiquadFilter_HP_Butter_ip_2_6_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT BiquadFilter_HP_Butter_ip_2_6_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT BiquadFilter_HP_Butter_ip_2_6_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BiquadFilter_HP_Butter_ip_2_6_reset_sync
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_6_reset_sync(rtl);

  FOR ALL : BiquadFilter_HP_Butter_ip_2_6_axi4_stream_slave
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_6_axi4_stream_slave(rtl);

  FOR ALL : BiquadFilter_HP_Butter_ip_2_6_dut
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_6_dut(rtl);

  FOR ALL : BiquadFilter_HP_Butter_ip_2_6_axi4_stream_master
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_6_axi4_stream_master(rtl);
...
BEGIN
  u_BiquadFilter_HP_Butter_ip_2_6_reset_sync_inst : BiquadFilter_HP_Butter_ip_2_6_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_BiquadFilter_HP_Butter_ip_2_6_axi4_stream_slave_inst : BiquadFilter_HP_Butter_ip_2_6_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_BiquadFilter_HP_Butter_ip_2_6_dut_inst : BiquadFilter_HP_Butter_ip_2_6_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_BiquadFilter_HP_Butter_ip_2_6_axi4_stream_master_inst : BiquadFilter_HP_Butter_ip_2_6_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
