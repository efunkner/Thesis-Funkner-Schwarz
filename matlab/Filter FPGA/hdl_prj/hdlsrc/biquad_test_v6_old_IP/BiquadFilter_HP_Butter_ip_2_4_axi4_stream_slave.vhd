-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFilter_HP_Butter_ip_2_4_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFilter_HP_Butter_ip_2_4_axi4_stream_slave
-- Source Path: BiquadFilter_HP_Butter_ip_2_4/BiquadFilter_HP_Butter_ip_2_4_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFilter_HP_Butter_ip_2_4_axi4_stream_slave IS
...
END BiquadFilter_HP_Butter_ip_2_4_axi4_stream_slave;


ARCHITECTURE rtl OF BiquadFilter_HP_Butter_ip_2_4_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT BiquadFilter_HP_Butter_ip_2_4_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BiquadFilter_HP_Butter_ip_2_4_fifo_data
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_4_fifo_data(rtl);
...
BEGIN
  u_BiquadFilter_HP_Butter_ip_2_4_fifo_data_inst : BiquadFilter_HP_Butter_ip_2_4_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
