-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFil_ip_2_3_src_Biquad_Filtrer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_2_3_src_Biquad_Filtrer
...
ENTITY BiquadFil_ip_2_3_src_Biquad_Filtrer IS
...
END BiquadFil_ip_2_3_src_Biquad_Filtrer;


ARCHITECTURE rtl OF BiquadFil_ip_2_3_src_Biquad_Filtrer IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_2_3_src_Biquad_Filter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BiquadFil_ip_2_3_src_Biquad_Filter1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFil_ip_2_3_src_Biquad_Filter
    USE ENTITY work.BiquadFil_ip_2_3_src_Biquad_Filter(rtl);

  FOR ALL : BiquadFil_ip_2_3_src_Biquad_Filter1
    USE ENTITY work.BiquadFil_ip_2_3_src_Biquad_Filter1(rtl);
...
BEGIN
  u_Biquad_Filter : BiquadFil_ip_2_3_src_Biquad_Filter
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Biquad_Filter1 : BiquadFil_ip_2_3_src_Biquad_Filter1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
