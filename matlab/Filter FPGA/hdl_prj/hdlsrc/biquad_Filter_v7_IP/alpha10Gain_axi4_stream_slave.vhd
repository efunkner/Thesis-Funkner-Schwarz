-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha10Gain_axi4_stream_slave
-- Source Path: 10Gain/10Gain_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY alpha10Gain_axi4_stream_slave IS
...
END alpha10Gain_axi4_stream_slave;


ARCHITECTURE rtl OF alpha10Gain_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT alpha10Gain_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : alpha10Gain_fifo_data
    USE ENTITY work.alpha10Gain_fifo_data(rtl);
...
BEGIN
  u_10Gain_fifo_data_inst : alpha10Gain_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
