-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Zero_Filter_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Zero_Filter_1
-- Source Path: Zero_Filter_1
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Zero_Filter_1 IS

  -- Component Declarations
  COMPONENT Zero_Filter_1_reset_sync
  ...
  COMPONENT Zero_Filter_1_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT Zero_Filter_1_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Zero_Filter_1_reset_sync
    USE ENTITY work.Zero_Filter_1_reset_sync(rtl);

  FOR ALL : Zero_Filter_1_axi4_stream_slave
    USE ENTITY work.Zero_Filter_1_axi4_stream_slave(rtl);

  FOR ALL : Zero_Filter_1_dut
    USE ENTITY work.Zero_Filter_1_dut(rtl);

  FOR ALL : Zero_Filter_1_axi4_stream_master
    USE ENTITY work.Zero_Filter_1_axi4_stream_master(rtl);
...
BEGIN
  u_Zero_Filter_1_reset_sync_inst : Zero_Filter_1_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_Zero_Filter_1_axi4_stream_slave_inst : Zero_Filter_1_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_Zero_Filter_1_dut_inst : Zero_Filter_1_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_Zero_Filter_1_axi4_stream_master_inst : Zero_Filter_1_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
