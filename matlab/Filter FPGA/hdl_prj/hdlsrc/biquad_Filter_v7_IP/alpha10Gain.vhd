-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain.vhd
-- Created: 2025-06-16 15:16:00
-- 
...
ARCHITECTURE rtl OF alpha10Gain IS

  -- Component Declarations
  COMPONENT alpha10Gain_reset_sync
  ...
  COMPONENT alpha10Gain_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT alpha10Gain_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : alpha10Gain_reset_sync
    USE ENTITY work.alpha10Gain_reset_sync(rtl);

  FOR ALL : alpha10Gain_axi4_stream_slave
    USE ENTITY work.alpha10Gain_axi4_stream_slave(rtl);

  FOR ALL : alpha10Gain_dut
    USE ENTITY work.alpha10Gain_dut(rtl);

  FOR ALL : alpha10Gain_axi4_stream_master
    USE ENTITY work.alpha10Gain_axi4_stream_master(rtl);
...
BEGIN
  u_10Gain_reset_sync_inst : alpha10Gain_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_10Gain_axi4_stream_slave_inst : alpha10Gain_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_10Gain_dut_inst : alpha10Gain_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_10Gain_axi4_stream_master_inst : alpha10Gain_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
