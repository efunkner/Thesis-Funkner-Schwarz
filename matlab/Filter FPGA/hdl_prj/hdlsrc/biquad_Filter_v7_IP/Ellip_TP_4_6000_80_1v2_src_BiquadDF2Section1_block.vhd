-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block.vhd
-- Created: 2025-06-21 16:12:45
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block
...
ENTITY Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block IS
...
END Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block;


ARCHITECTURE rtl OF Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block IS
  ...
  SIGNAL numPostPipe1Dly                  : signed(63 DOWNTO 0);  -- sfix64_En53
  ...
  SIGNAL adder_add_cast_3                 : signed(66 DOWNTO 0);  -- sfix67_En53
  SIGNAL adder_add_cast_4                 : signed(66 DOWNTO 0);  -- sfix67_En53
  SIGNAL numSum2                          : signed(66 DOWNTO 0);  -- sfix67_En53
  SIGNAL numSum2Dly                       : signed(66 DOWNTO 0);  -- sfix67_En53
  SIGNAL adder_add_cast_5                 : signed(66 DOWNTO 0);  -- sfix67_En53
  SIGNAL numSum1                          : signed(66 DOWNTO 0);  -- sfix67_En53
  SIGNAL numSumReg_1                      : signed(66 DOWNTO 0);  -- sfix67_En53
...
BEGIN
  ...
  denProd2 <= to_signed(-885264407, 32) * state2;
  ...
  denProd1 <= to_signed(1391137640, 32) * state1;
  ...
  numProd1 <= to_signed(1180265447, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(1336172725, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(1180265447, 32) * numPrePipe3;
  ...
  convertOut <= resize(numSumReg_1(66 DOWNTO 37), 32);
