-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Gain_10_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Gain_10_src_Biquad_Filter
...
ENTITY Gain_10_src_Biquad_Filter IS
...
END Gain_10_src_Biquad_Filter;


ARCHITECTURE rtl OF Gain_10_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT Gain_10_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Gain_10_src_BiquadDF2Section1
    USE ENTITY work.Gain_10_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : Gain_10_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
