-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Zero_Filter_1_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Zero_Filter_1_axi4_stream_slave
-- Source Path: Zero_Filter_1/Zero_Filter_1_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Zero_Filter_1_axi4_stream_slave IS
...
END Zero_Filter_1_axi4_stream_slave;


ARCHITECTURE rtl OF Zero_Filter_1_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT Zero_Filter_1_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Zero_Filter_1_fifo_data
    USE ENTITY work.Zero_Filter_1_fifo_data(rtl);
...
BEGIN
  u_Zero_Filter_1_fifo_data_inst : Zero_Filter_1_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
