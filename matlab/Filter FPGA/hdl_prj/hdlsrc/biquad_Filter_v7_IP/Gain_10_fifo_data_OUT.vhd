-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Gain_10_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Gain_10_fifo_data_OUT
-- Source Path: Gain_10/Gain_10_axi4_stream_master/Gain_10_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Gain_10_fifo_data_OUT IS
...
END Gain_10_fifo_data_OUT;


ARCHITECTURE rtl OF Gain_10_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT Gain_10_SimpleDualPortRAM_generic
  ...
  FOR ALL : Gain_10_SimpleDualPortRAM_generic
    USE ENTITY work.Gain_10_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_Gain_10_fifo_data_OUT_classic_ram_generic : Gain_10_SimpleDualPortRAM_generic
