-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain_src_Biquad_Filter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha10Gain_src_Biquad_Filter1
...
ENTITY alpha10Gain_src_Biquad_Filter1 IS
...
END alpha10Gain_src_Biquad_Filter1;


ARCHITECTURE rtl OF alpha10Gain_src_Biquad_Filter1 IS

  -- Component Declarations
  COMPONENT alpha10Gain_src_BiquadDF2Section1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : alpha10Gain_src_BiquadDF2Section1_block
    USE ENTITY work.alpha10Gain_src_BiquadDF2Section1_block(rtl);
...
BEGIN
  u_BiquadSection1_inst : alpha10Gain_src_BiquadDF2Section1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
