-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_300v2_src_Biquad_Filtrer.vhd
-- Created: 2025-06-21 15:40:23
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_300v2_src_Biquad_Filtrer
...
ENTITY Butter_HP_4_300v2_src_Biquad_Filtrer IS
...
END Butter_HP_4_300v2_src_Biquad_Filtrer;


ARCHITECTURE rtl OF Butter_HP_4_300v2_src_Biquad_Filtrer IS

  -- Component Declarations
  COMPONENT Butter_HP_4_300v2_src_Biquad_Filter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Butter_HP_4_300v2_src_Biquad_Filter1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Butter_HP_4_300v2_src_Biquad_Filter
    USE ENTITY work.Butter_HP_4_300v2_src_Biquad_Filter(rtl);

  FOR ALL : Butter_HP_4_300v2_src_Biquad_Filter1
    USE ENTITY work.Butter_HP_4_300v2_src_Biquad_Filter1(rtl);
...
BEGIN
  u_Biquad_Filter : Butter_HP_4_300v2_src_Biquad_Filter
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Biquad_Filter1 : Butter_HP_4_300v2_src_Biquad_Filter1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
