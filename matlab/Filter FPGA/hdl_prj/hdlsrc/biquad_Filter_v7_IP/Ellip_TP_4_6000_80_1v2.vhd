-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Ellip_TP_4_6000_80_1v2.vhd
-- Created: 2025-06-21 16:12:49
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Ellip_TP_4_6000_80_1v2
-- Source Path: Ellip_TP_4_6000_80_1v2
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Ellip_TP_4_6000_80_1v2 IS
...
END Ellip_TP_4_6000_80_1v2;


ARCHITECTURE rtl OF Ellip_TP_4_6000_80_1v2 IS

  -- Component Declarations
  COMPONENT Ellip_TP_4_6000_80_1v2_reset_sync
  ...
  COMPONENT Ellip_TP_4_6000_80_1v2_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT Ellip_TP_4_6000_80_1v2_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT Ellip_TP_4_6000_80_1v2_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Ellip_TP_4_6000_80_1v2_reset_sync
    USE ENTITY work.Ellip_TP_4_6000_80_1v2_reset_sync(rtl);

  FOR ALL : Ellip_TP_4_6000_80_1v2_axi4_stream_slave
    USE ENTITY work.Ellip_TP_4_6000_80_1v2_axi4_stream_slave(rtl);

  FOR ALL : Ellip_TP_4_6000_80_1v2_dut
    USE ENTITY work.Ellip_TP_4_6000_80_1v2_dut(rtl);

  FOR ALL : Ellip_TP_4_6000_80_1v2_axi4_stream_master
    USE ENTITY work.Ellip_TP_4_6000_80_1v2_axi4_stream_master(rtl);
...
BEGIN
  u_Ellip_TP_4_6000_80_1v2_reset_sync_inst : Ellip_TP_4_6000_80_1v2_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_Ellip_TP_4_6000_80_1v2_axi4_stream_slave_inst : Ellip_TP_4_6000_80_1v2_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_Ellip_TP_4_6000_80_1v2_dut_inst : Ellip_TP_4_6000_80_1v2_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_Ellip_TP_4_6000_80_1v2_axi4_stream_master_inst : Ellip_TP_4_6000_80_1v2_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
