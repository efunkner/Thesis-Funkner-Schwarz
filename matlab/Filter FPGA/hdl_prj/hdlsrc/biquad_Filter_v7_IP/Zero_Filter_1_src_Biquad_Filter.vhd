-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Zero_Filter_1_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Zero_Filter_1_src_Biquad_Filter
...
ENTITY Zero_Filter_1_src_Biquad_Filter IS
...
END Zero_Filter_1_src_Biquad_Filter;


ARCHITECTURE rtl OF Zero_Filter_1_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT Zero_Filter_1_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Zero_Filter_1_src_BiquadDF2Section1
    USE ENTITY work.Zero_Filter_1_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : Zero_Filter_1_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
