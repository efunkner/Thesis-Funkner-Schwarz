-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Gain_10_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Gain_10_fifo_TLAST_OUT
-- Source Path: Gain_10/Gain_10_axi4_stream_master/Gain_10_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Gain_10_fifo_TLAST_OUT IS
...
END Gain_10_fifo_TLAST_OUT;


ARCHITECTURE rtl OF Gain_10_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT Gain_10_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : Gain_10_SimpleDualPortRAM_singlebit
    USE ENTITY work.Gain_10_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_Gain_10_fifo_TLAST_OUT_classic_ram_singlebit : Gain_10_SimpleDualPortRAM_singlebit
