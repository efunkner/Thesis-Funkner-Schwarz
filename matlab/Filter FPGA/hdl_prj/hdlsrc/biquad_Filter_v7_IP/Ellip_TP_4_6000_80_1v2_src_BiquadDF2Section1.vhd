-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1
...
ENTITY Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1 IS
...
END Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1;


ARCHITECTURE rtl OF Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-619462286, 32) * state2;
  ...
  denProd1 <= to_signed(1534267556, 32) * state1;
  ...
  numProd1 <= to_signed(730094215, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(1325079508, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(730094215, 32) * numPrePipe3;
