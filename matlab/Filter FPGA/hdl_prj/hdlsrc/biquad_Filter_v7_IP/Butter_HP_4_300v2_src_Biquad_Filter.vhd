-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_300v2_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_300v2_src_Biquad_Filter
...
ENTITY Butter_HP_4_300v2_src_Biquad_Filter IS
...
END Butter_HP_4_300v2_src_Biquad_Filter;


ARCHITECTURE rtl OF Butter_HP_4_300v2_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT Butter_HP_4_300v2_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Butter_HP_4_300v2_src_BiquadDF2Section1
    USE ENTITY work.Butter_HP_4_300v2_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : Butter_HP_4_300v2_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
