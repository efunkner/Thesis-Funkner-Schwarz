-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_TP_4_6000v2_src_Biquad_Filtrer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_TP_4_6000v2_src_Biquad_Filtrer
...
ENTITY Butter_TP_4_6000v2_src_Biquad_Filtrer IS
...
END Butter_TP_4_6000v2_src_Biquad_Filtrer;


ARCHITECTURE rtl OF Butter_TP_4_6000v2_src_Biquad_Filtrer IS

  -- Component Declarations
  COMPONENT Butter_TP_4_6000v2_src_Biquad_Filter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Butter_TP_4_6000v2_src_Biquad_Filter1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Butter_TP_4_6000v2_src_Biquad_Filter
    USE ENTITY work.Butter_TP_4_6000v2_src_Biquad_Filter(rtl);

  FOR ALL : Butter_TP_4_6000v2_src_Biquad_Filter1
    USE ENTITY work.Butter_TP_4_6000v2_src_Biquad_Filter1(rtl);
...
BEGIN
  u_Biquad_Filter : Butter_TP_4_6000v2_src_Biquad_Filter
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Biquad_Filter1 : Butter_TP_4_6000v2_src_Biquad_Filter1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
