-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Gain_10_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Gain_10_axi4_stream_slave
-- Source Path: Gain_10/Gain_10_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Gain_10_axi4_stream_slave IS
...
END Gain_10_axi4_stream_slave;


ARCHITECTURE rtl OF Gain_10_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT Gain_10_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Gain_10_fifo_data
    USE ENTITY work.Gain_10_fifo_data(rtl);
...
BEGIN
  u_Gain_10_fifo_data_inst : Gain_10_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
