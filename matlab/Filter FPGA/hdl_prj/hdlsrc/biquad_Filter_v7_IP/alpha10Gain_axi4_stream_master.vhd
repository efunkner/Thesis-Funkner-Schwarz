-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain_axi4_stream_master.vhd
-- Created: 2025-06-16 15:15:59
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: alpha10Gain_axi4_stream_master
-- Source Path: 10Gain/10Gain_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY alpha10Gain_axi4_stream_master IS
...
END alpha10Gain_axi4_stream_master;


ARCHITECTURE rtl OF alpha10Gain_axi4_stream_master IS

  -- Component Declarations
  COMPONENT alpha10Gain_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT alpha10Gain_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : alpha10Gain_fifo_data_OUT
    USE ENTITY work.alpha10Gain_fifo_data_OUT(rtl);

  FOR ALL : alpha10Gain_fifo_TLAST_OUT
    USE ENTITY work.alpha10Gain_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_10Gain_fifo_data_OUT_inst : alpha10Gain_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_10Gain_fifo_TLAST_OUT_inst : alpha10Gain_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
