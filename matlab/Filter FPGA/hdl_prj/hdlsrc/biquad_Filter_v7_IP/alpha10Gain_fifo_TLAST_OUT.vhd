-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha10Gain_fifo_TLAST_OUT
-- Source Path: 10Gain/10Gain_axi4_stream_master/10Gain_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY alpha10Gain_fifo_TLAST_OUT IS
...
END alpha10Gain_fifo_TLAST_OUT;


ARCHITECTURE rtl OF alpha10Gain_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT alpha10Gain_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : alpha10Gain_SimpleDualPortRAM_singlebit
    USE ENTITY work.alpha10Gain_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_10Gain_fifo_TLAST_OUT_classic_ram_singlebit : alpha10Gain_SimpleDualPortRAM_singlebit
