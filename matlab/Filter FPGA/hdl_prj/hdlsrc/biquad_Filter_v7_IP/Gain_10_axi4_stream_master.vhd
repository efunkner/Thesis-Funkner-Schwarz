-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Gain_10_axi4_stream_master.vhd
-- Created: 2025-06-16 15:19:09
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Gain_10_axi4_stream_master
-- Source Path: Gain_10/Gain_10_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Gain_10_axi4_stream_master IS
...
END Gain_10_axi4_stream_master;


ARCHITECTURE rtl OF Gain_10_axi4_stream_master IS

  -- Component Declarations
  COMPONENT Gain_10_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Gain_10_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Gain_10_fifo_data_OUT
    USE ENTITY work.Gain_10_fifo_data_OUT(rtl);

  FOR ALL : Gain_10_fifo_TLAST_OUT
    USE ENTITY work.Gain_10_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_Gain_10_fifo_data_OUT_inst : Gain_10_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Gain_10_fifo_TLAST_OUT_inst : Gain_10_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
