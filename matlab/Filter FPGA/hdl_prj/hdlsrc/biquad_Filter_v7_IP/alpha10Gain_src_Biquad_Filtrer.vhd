-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain_src_Biquad_Filtrer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha10Gain_src_Biquad_Filtrer
...
ENTITY alpha10Gain_src_Biquad_Filtrer IS
...
END alpha10Gain_src_Biquad_Filtrer;


ARCHITECTURE rtl OF alpha10Gain_src_Biquad_Filtrer IS

  -- Component Declarations
  COMPONENT alpha10Gain_src_Biquad_Filter
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT alpha10Gain_src_Biquad_Filter1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : alpha10Gain_src_Biquad_Filter
    USE ENTITY work.alpha10Gain_src_Biquad_Filter(rtl);

  FOR ALL : alpha10Gain_src_Biquad_Filter1
    USE ENTITY work.alpha10Gain_src_Biquad_Filter1(rtl);
...
BEGIN
  u_Biquad_Filter : alpha10Gain_src_Biquad_Filter
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Biquad_Filter1 : alpha10Gain_src_Biquad_Filter1
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
