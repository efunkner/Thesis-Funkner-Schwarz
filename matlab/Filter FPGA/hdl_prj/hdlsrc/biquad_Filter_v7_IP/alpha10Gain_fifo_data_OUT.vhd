-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\alpha10Gain_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: alpha10Gain_fifo_data_OUT
-- Source Path: 10Gain/10Gain_axi4_stream_master/10Gain_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY alpha10Gain_fifo_data_OUT IS
...
END alpha10Gain_fifo_data_OUT;


ARCHITECTURE rtl OF alpha10Gain_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT alpha10Gain_SimpleDualPortRAM_generic
  ...
  FOR ALL : alpha10Gain_SimpleDualPortRAM_generic
    USE ENTITY work.alpha10Gain_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_10Gain_fifo_data_OUT_classic_ram_generic : alpha10Gain_SimpleDualPortRAM_generic
