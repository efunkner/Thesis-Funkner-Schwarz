-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_TP_4_6000v2_src_BiquadDF2Section1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_TP_4_6000v2_src_BiquadDF2Section1
...
ENTITY Butter_TP_4_6000v2_src_BiquadDF2Section1 IS
...
END Butter_TP_4_6000v2_src_BiquadDF2Section1;


ARCHITECTURE rtl OF Butter_TP_4_6000v2_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-616394288, 32) * state2;
  ...
  denProd1 <= to_signed(1195106706, 32) * state1;
  ...
  numProd1 <= to_signed(990058812, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(1980117624, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(990058812, 32) * numPrePipe3;
