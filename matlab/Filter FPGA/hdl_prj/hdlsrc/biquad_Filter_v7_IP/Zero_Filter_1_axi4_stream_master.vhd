-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Zero_Filter_1_axi4_stream_master.vhd
-- Created: 2025-06-16 15:03:07
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Zero_Filter_1_axi4_stream_master
-- Source Path: Zero_Filter_1/Zero_Filter_1_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Zero_Filter_1_axi4_stream_master IS
...
END Zero_Filter_1_axi4_stream_master;


ARCHITECTURE rtl OF Zero_Filter_1_axi4_stream_master IS

  -- Component Declarations
  COMPONENT Zero_Filter_1_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Zero_Filter_1_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Zero_Filter_1_fifo_data_OUT
    USE ENTITY work.Zero_Filter_1_fifo_data_OUT(rtl);

  FOR ALL : Zero_Filter_1_fifo_TLAST_OUT
    USE ENTITY work.Zero_Filter_1_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_Zero_Filter_1_fifo_data_OUT_inst : Zero_Filter_1_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Zero_Filter_1_fifo_TLAST_OUT_inst : Zero_Filter_1_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
