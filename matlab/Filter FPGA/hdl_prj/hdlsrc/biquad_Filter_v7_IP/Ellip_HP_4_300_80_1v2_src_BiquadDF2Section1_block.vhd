-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1_block.vhd
-- Created: 2025-06-21 16:11:12
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1_block
...
ENTITY Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1_block IS
...
END Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1_block;


ARCHITECTURE rtl OF Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1_block IS
...
BEGIN
  ...
  denProd2 <= to_signed(-1062213289, 32) * state2;
  ...
  denProd1 <= to_signed(2134288295, 32) * state1;
  ...
  numProd1 <= to_signed(868715157, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-1737366607, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(868715157, 32) * numPrePipe3;
