-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_300_80_1v2_src_BiquadDF2Section1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_300_80_1v2_src_BiquadDF2Section1
...
ENTITY Butter_HP_4_300_80_1v2_src_BiquadDF2Section1 IS
...
END Butter_HP_4_300_80_1v2_src_BiquadDF2Section1;


ARCHITECTURE rtl OF Butter_HP_4_300_80_1v2_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-1041955417, 32) * state2;
  ...
  denProd1 <= to_signed(2114066115, 32) * state1;
  ...
  numProd1 <= to_signed(1057440839, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-2114881678, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(1057440839, 32) * numPrePipe3;
