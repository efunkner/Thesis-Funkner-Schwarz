...
USE work.Biquad_Filtrer_pkg.ALL;
...
ARCHITECTURE rtl OF Biquad_Filtrer IS
  ...
  SIGNAL Sum3_out1_1                      : signed(31 DOWNTO 0);  -- sfix32_En16
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        delayMatch_reg(0) <= In1_1;
        delayMatch_reg(1) <= delayMatch_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch_process;

  In1_2 <= delayMatch_reg(1);
  ...
  Delay_out1 <= Sum_out1 WHEN enb_1_2_1 = '1' ELSE
      Delay_bypass_reg;
  ...
  b0_mul_temp <= kconst_1 * Sum_out1_1;
  ...
  Sum2_add_cast_1 <= resize(Sum3_out1_1, 33);
  ...
  Sum2_out1_1 <= Sum2_out1 WHEN enb_1_2_1 = '1' ELSE
      t_bypass_reg;
