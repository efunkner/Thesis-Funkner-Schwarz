-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\LP_Butter_2_1kHz_fix32_16_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LP_Butter_2_1kHz_fix32_16_src_Biquad_Filter
...
ENTITY LP_Butter_2_1kHz_fix32_16_src_Biquad_Filter IS
...
END LP_Butter_2_1kHz_fix32_16_src_Biquad_Filter;


ARCHITECTURE rtl OF LP_Butter_2_1kHz_fix32_16_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT LP_Butter_2_1kHz_fix32_16_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : LP_Butter_2_1kHz_fix32_16_src_BiquadDF2Section1
    USE ENTITY work.LP_Butter_2_1kHz_fix32_16_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : LP_Butter_2_1kHz_fix32_16_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
