-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BP_Butter_2_300Hz_4kHz_fix32_16_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BP_Butter_2_300Hz_4kHz_fix32_16_axi4_stream_master
-- Source Path: BP_Butter_2_300Hz_4kHz_fix32_16/BP_Butter_2_300Hz_4kHz_fix32_16_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BP_Butter_2_300Hz_4kHz_fix32_16_axi4_stream_master IS
...
END BP_Butter_2_300Hz_4kHz_fix32_16_axi4_stream_master;


ARCHITECTURE rtl OF BP_Butter_2_300Hz_4kHz_fix32_16_axi4_stream_master IS

  -- Component Declarations
  COMPONENT BP_Butter_2_300Hz_4kHz_fix32_16_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BP_Butter_2_300Hz_4kHz_fix32_16_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BP_Butter_2_300Hz_4kHz_fix32_16_fifo_data_OUT
    USE ENTITY work.BP_Butter_2_300Hz_4kHz_fix32_16_fifo_data_OUT(rtl);

  FOR ALL : BP_Butter_2_300Hz_4kHz_fix32_16_fifo_TLAST_OUT
    USE ENTITY work.BP_Butter_2_300Hz_4kHz_fix32_16_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_BP_Butter_2_300Hz_4kHz_fix32_16_fifo_data_OUT_inst : BP_Butter_2_300Hz_4kHz_fix32_16_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_BP_Butter_2_300Hz_4kHz_fix32_16_fifo_TLAST_OUT_inst : BP_Butter_2_300Hz_4kHz_fix32_16_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
