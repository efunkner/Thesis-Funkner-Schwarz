-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\TP_Butter_2_5kHz_fix32_16_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TP_Butter_2_5kHz_fix32_16_axi4_stream_master
-- Source Path: TP_Butter_2_5kHz_fix32_16/TP_Butter_2_5kHz_fix32_16_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TP_Butter_2_5kHz_fix32_16_axi4_stream_master IS
...
END TP_Butter_2_5kHz_fix32_16_axi4_stream_master;


ARCHITECTURE rtl OF TP_Butter_2_5kHz_fix32_16_axi4_stream_master IS

  -- Component Declarations
  COMPONENT TP_Butter_2_5kHz_fix32_16_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT TP_Butter_2_5kHz_fix32_16_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : TP_Butter_2_5kHz_fix32_16_fifo_data_OUT
    USE ENTITY work.TP_Butter_2_5kHz_fix32_16_fifo_data_OUT(rtl);

  FOR ALL : TP_Butter_2_5kHz_fix32_16_fifo_TLAST_OUT
    USE ENTITY work.TP_Butter_2_5kHz_fix32_16_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_TP_Butter_2_5kHz_fix32_16_fifo_data_OUT_inst : TP_Butter_2_5kHz_fix32_16_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_TP_Butter_2_5kHz_fix32_16_fifo_TLAST_OUT_inst : TP_Butter_2_5kHz_fix32_16_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
