-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BP_Butter_2_600Hz_3kHz_fix32_16_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BP_Butter_2_600Hz_3kHz_fix32_16_src_Biquad_Filter
...
ENTITY BP_Butter_2_600Hz_3kHz_fix32_16_src_Biquad_Filter IS
...
END BP_Butter_2_600Hz_3kHz_fix32_16_src_Biquad_Filter;


ARCHITECTURE rtl OF BP_Butter_2_600Hz_3kHz_fix32_16_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT BP_Butter_2_600Hz_3kHz_fix32_16_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BP_Butter_2_600Hz_3kHz_fix32_16_src_BiquadDF2Section1
    USE ENTITY work.BP_Butter_2_600Hz_3kHz_fix32_16_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : BP_Butter_2_600Hz_3kHz_fix32_16_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
