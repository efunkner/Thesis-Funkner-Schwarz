-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BP_Butter_2_500Hz_2kHz_fix32_16_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BP_Butter_2_500Hz_2kHz_fix32_16_axi4_stream_slave
-- Source Path: BP_Butter_2_500Hz_2kHz_fix32_16/BP_Butter_2_500Hz_2kHz_fix32_16_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BP_Butter_2_500Hz_2kHz_fix32_16_axi4_stream_slave IS
...
END BP_Butter_2_500Hz_2kHz_fix32_16_axi4_stream_slave;


ARCHITECTURE rtl OF BP_Butter_2_500Hz_2kHz_fix32_16_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT BP_Butter_2_500Hz_2kHz_fix32_16_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BP_Butter_2_500Hz_2kHz_fix32_16_fifo_data
    USE ENTITY work.BP_Butter_2_500Hz_2kHz_fix32_16_fifo_data(rtl);
...
BEGIN
  u_BP_Butter_2_500Hz_2kHz_fix32_16_fifo_data_inst : BP_Butter_2_500Hz_2kHz_fix32_16_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
