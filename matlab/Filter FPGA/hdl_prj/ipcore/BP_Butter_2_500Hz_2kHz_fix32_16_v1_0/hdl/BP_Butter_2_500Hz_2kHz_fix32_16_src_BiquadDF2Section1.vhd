-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BP_Butter_2_500Hz_2kHz_fix32_16_src_BiquadDF2Section1.vhd
-- Created: 2025-06-23 12:13:46
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BP_Butter_2_500Hz_2kHz_fix32_16_src_BiquadDF2Section1
...
ENTITY BP_Butter_2_500Hz_2kHz_fix32_16_src_BiquadDF2Section1 IS
...
END BP_Butter_2_500Hz_2kHz_fix32_16_src_BiquadDF2Section1;


ARCHITECTURE rtl OF BP_Butter_2_500Hz_2kHz_fix32_16_src_BiquadDF2Section1 IS
  ...
  SIGNAL numPostPipe1Dly                  : signed(63 DOWNTO 0);  -- sfix64_En50
  ...
  SIGNAL adder_add_cast_3                 : signed(66 DOWNTO 0);  -- sfix67_En50
  SIGNAL adder_add_cast_4                 : signed(66 DOWNTO 0);  -- sfix67_En50
  SIGNAL numSum2                          : signed(66 DOWNTO 0);  -- sfix67_En50
  SIGNAL numSum2Dly                       : signed(66 DOWNTO 0);  -- sfix67_En50
  SIGNAL adder_add_cast_5                 : signed(66 DOWNTO 0);  -- sfix67_En50
  SIGNAL numSum1                          : signed(66 DOWNTO 0);  -- sfix67_En50
  SIGNAL numSumReg_1                      : signed(66 DOWNTO 0);  -- sfix67_En50
...
BEGIN
  ...
  denProd2 <= to_signed(-881197142, 32) * state2;
  ...
  denProd1 <= to_signed(1938160267, 32) * state1;
  ...
  convertOut <= numSumReg_1(65 DOWNTO 34);
