-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_TP_4_1000_v1_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_TP_4_1000_v1_axi4_stream_slave
-- Source Path: Butter_TP_4_1000_v1/Butter_TP_4_1000_v1_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Butter_TP_4_1000_v1_axi4_stream_slave IS
...
END Butter_TP_4_1000_v1_axi4_stream_slave;


ARCHITECTURE rtl OF Butter_TP_4_1000_v1_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT Butter_TP_4_1000_v1_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Butter_TP_4_1000_v1_fifo_data
    USE ENTITY work.Butter_TP_4_1000_v1_fifo_data(rtl);
...
BEGIN
  u_Butter_TP_4_1000_v1_fifo_data_inst : Butter_TP_4_1000_v1_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
