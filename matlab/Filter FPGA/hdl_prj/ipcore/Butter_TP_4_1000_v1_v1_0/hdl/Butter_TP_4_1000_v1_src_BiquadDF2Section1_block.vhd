-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_TP_4_1000_v1_src_BiquadDF2Section1_block.vhd
-- Created: 2025-06-11 16:58:28
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_TP_4_1000_v1_src_BiquadDF2Section1_block
...
ENTITY Butter_TP_4_1000_v1_src_BiquadDF2Section1_block IS
...
END Butter_TP_4_1000_v1_src_BiquadDF2Section1_block;


ARCHITECTURE rtl OF Butter_TP_4_1000_v1_src_BiquadDF2Section1_block IS
  ...
  SIGNAL numProd1                         : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL numPostPipe1                     : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL numPostPipe1Dly                  : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL numPrePipe2                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd2                         : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL numPostPipe2                     : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL numPrePipe3                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd3                         : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL numPostPipe3                     : signed(63 DOWNTO 0);  -- sfix64_En54
  SIGNAL adder_add_cast_3                 : signed(66 DOWNTO 0);  -- sfix67_En54
  SIGNAL adder_add_cast_4                 : signed(66 DOWNTO 0);  -- sfix67_En54
  SIGNAL numSum2                          : signed(66 DOWNTO 0);  -- sfix67_En54
  SIGNAL numSum2Dly                       : signed(66 DOWNTO 0);  -- sfix67_En54
  SIGNAL adder_add_cast_5                 : signed(66 DOWNTO 0);  -- sfix67_En54
  SIGNAL numSum1                          : signed(66 DOWNTO 0);  -- sfix67_En54
  SIGNAL numSumReg_1                      : signed(66 DOWNTO 0);  -- sfix67_En54
...
BEGIN
  ...
  numProd1 <= to_signed(1049276541, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(2098553081, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(1049276541, 32) * numPrePipe3;
  ...
  convertOut <= resize(numSumReg_1(66 DOWNTO 38), 32);
