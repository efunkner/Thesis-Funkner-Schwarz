-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter1
...
ENTITY BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter1 IS
...
END BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter1;


ARCHITECTURE rtl OF BiquadFilter_HP_Butter_ip_2_6_src_Biquad_Filter1 IS

  -- Component Declarations
  COMPONENT BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1_block
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1_block(rtl);
...
BEGIN
  u_BiquadSection1_inst : BiquadFilter_HP_Butter_ip_2_6_src_BiquadDF2Section1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
