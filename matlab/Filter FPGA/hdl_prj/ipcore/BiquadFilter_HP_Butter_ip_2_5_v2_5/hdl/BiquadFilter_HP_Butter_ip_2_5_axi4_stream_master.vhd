-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFilter_HP_Butter_ip_2_5_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFilter_HP_Butter_ip_2_5_axi4_stream_master
-- Source Path: BiquadFilter_HP_Butter_ip_2_5/BiquadFilter_HP_Butter_ip_2_5_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFilter_HP_Butter_ip_2_5_axi4_stream_master IS
...
END BiquadFilter_HP_Butter_ip_2_5_axi4_stream_master;


ARCHITECTURE rtl OF BiquadFilter_HP_Butter_ip_2_5_axi4_stream_master IS

  -- Component Declarations
  COMPONENT BiquadFilter_HP_Butter_ip_2_5_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BiquadFilter_HP_Butter_ip_2_5_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BiquadFilter_HP_Butter_ip_2_5_fifo_data_OUT
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_5_fifo_data_OUT(rtl);

  FOR ALL : BiquadFilter_HP_Butter_ip_2_5_fifo_TLAST_OUT
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_5_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_BiquadFilter_HP_Butter_ip_2_5_fifo_data_OUT_inst : BiquadFilter_HP_Butter_ip_2_5_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_BiquadFilter_HP_Butter_ip_2_5_fifo_TLAST_OUT_inst : BiquadFilter_HP_Butter_ip_2_5_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
