-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFilter_HP_Butter_ip_2_5_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFilter_HP_Butter_ip_2_5_axi_lite
-- Source Path: BiquadFilter_HP_Butter_ip_2_5/BiquadFilter_HP_Butter_ip_2_5_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFilter_HP_Butter_ip_2_5_axi_lite IS
...
END BiquadFilter_HP_Butter_ip_2_5_axi_lite;


ARCHITECTURE rtl OF BiquadFilter_HP_Butter_ip_2_5_axi_lite IS

  -- Component Declarations
  COMPONENT BiquadFilter_HP_Butter_ip_2_5_addr_decoder
  ...
  COMPONENT BiquadFilter_HP_Butter_ip_2_5_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BiquadFilter_HP_Butter_ip_2_5_addr_decoder
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_5_addr_decoder(rtl);

  FOR ALL : BiquadFilter_HP_Butter_ip_2_5_axi_lite_module
    USE ENTITY work.BiquadFilter_HP_Butter_ip_2_5_axi_lite_module(rtl);
...
BEGIN
  u_BiquadFilter_HP_Butter_ip_2_5_addr_decoder_inst : BiquadFilter_HP_Butter_ip_2_5_addr_decoder
  ...
  u_BiquadFilter_HP_Butter_ip_2_5_axi_lite_module_inst : BiquadFilter_HP_Butter_ip_2_5_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
