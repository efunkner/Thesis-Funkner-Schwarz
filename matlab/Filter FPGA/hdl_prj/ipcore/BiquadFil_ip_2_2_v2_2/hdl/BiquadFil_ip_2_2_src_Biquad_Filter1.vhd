-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v6_old_IP\BiquadFil_ip_2_2_src_Biquad_Filter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_2_2_src_Biquad_Filter1
...
ENTITY BiquadFil_ip_2_2_src_Biquad_Filter1 IS
...
END BiquadFil_ip_2_2_src_Biquad_Filter1;


ARCHITECTURE rtl OF BiquadFil_ip_2_2_src_Biquad_Filter1 IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_2_2_src_BiquadDF2Section1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFil_ip_2_2_src_BiquadDF2Section1_block
    USE ENTITY work.BiquadFil_ip_2_2_src_BiquadDF2Section1_block(rtl);
...
BEGIN
  u_BiquadSection1_inst : BiquadFil_ip_2_2_src_BiquadDF2Section1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
