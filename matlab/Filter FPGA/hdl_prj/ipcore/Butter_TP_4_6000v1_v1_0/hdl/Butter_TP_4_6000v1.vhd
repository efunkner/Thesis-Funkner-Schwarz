-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_TP_4_6000v1.vhd
-- Created: 2025-06-21 12:32:33
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_TP_4_6000v1
-- Source Path: Butter_TP_4_6000v1
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Butter_TP_4_6000v1;


ARCHITECTURE rtl OF Butter_TP_4_6000v1 IS

  -- Component Declarations
  COMPONENT Butter_TP_4_6000v1_reset_sync
  ...
  COMPONENT Butter_TP_4_6000v1_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT Butter_TP_4_6000v1_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          ...
          Out1                            :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32
          Out2                            :   OUT   std_logic  -- ufix1
          );
  END COMPONENT;

  COMPONENT Butter_TP_4_6000v1_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Butter_TP_4_6000v1_reset_sync
    USE ENTITY work.Butter_TP_4_6000v1_reset_sync(rtl);

  FOR ALL : Butter_TP_4_6000v1_axi4_stream_slave
    USE ENTITY work.Butter_TP_4_6000v1_axi4_stream_slave(rtl);

  FOR ALL : Butter_TP_4_6000v1_dut
    USE ENTITY work.Butter_TP_4_6000v1_dut(rtl);

  FOR ALL : Butter_TP_4_6000v1_axi4_stream_master
    USE ENTITY work.Butter_TP_4_6000v1_axi4_stream_master(rtl);
  ...
  SIGNAL Out1_sig_signed                  : signed(31 DOWNTO 0);  -- sfix32
...
BEGIN
  u_Butter_TP_4_6000v1_reset_sync_inst : Butter_TP_4_6000v1_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_Butter_TP_4_6000v1_axi4_stream_slave_inst : Butter_TP_4_6000v1_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_Butter_TP_4_6000v1_dut_inst : Butter_TP_4_6000v1_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              Out1 => Out1_sig,  -- sfix32
              Out2 => Out2_sig  -- ufix1
              );

  u_Butter_TP_4_6000v1_axi4_stream_master_inst : Butter_TP_4_6000v1_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
