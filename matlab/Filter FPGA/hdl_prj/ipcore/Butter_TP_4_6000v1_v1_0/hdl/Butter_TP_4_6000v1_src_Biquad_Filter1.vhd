-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_TP_4_6000v1_src_Biquad_Filter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_TP_4_6000v1_src_Biquad_Filter1
-- Source Path: biquad_Filter_v7_IP/Biquad Filtrer/Biquad Filter1
-- Hierarchy Level: 1
-- Model version: 1.100
-- 
-- Biquad Filter
...
ENTITY Butter_TP_4_6000v1_src_Biquad_Filter1 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        dataIn                            :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
        validIn                           :   IN    std_logic;
        dataOut                           :   OUT   std_logic_vector(31 DOWNTO 0);  -- int32
        validOut                          :   OUT   std_logic
        );
END Butter_TP_4_6000v1_src_Biquad_Filter1;


ARCHITECTURE rtl OF Butter_TP_4_6000v1_src_Biquad_Filter1 IS

  -- Component Declarations
  COMPONENT Butter_TP_4_6000v1_src_BiquadDF2Section1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- int32
  ...
  FOR ALL : Butter_TP_4_6000v1_src_BiquadDF2Section1_block
    USE ENTITY work.Butter_TP_4_6000v1_src_BiquadDF2Section1_block(rtl);

  -- Signals
  SIGNAL dataIn_signed                    : signed(31 DOWNTO 0);  -- int32
  SIGNAL sec0reg                          : signed(31 DOWNTO 0);  -- int32
  SIGNAL sec0mul                          : signed(63 DOWNTO 0);  -- sfix64_En30
  SIGNAL sec0mulreg                       : signed(63 DOWNTO 0);  -- sfix64_En30
  SIGNAL sec0dtc                          : signed(31 DOWNTO 0);  -- int32
  SIGNAL sec0out                          : signed(31 DOWNTO 0);  -- int32
  ...
  SIGNAL zerooutconst                     : signed(31 DOWNTO 0);  -- int32
  SIGNAL sec1out_signed                   : signed(31 DOWNTO 0);  -- int32
  SIGNAL sec1mul                          : signed(63 DOWNTO 0);  -- sfix64_En30
  SIGNAL sec1mulreg                       : signed(63 DOWNTO 0);  -- sfix64_En30
  SIGNAL sec1dtc                          : signed(31 DOWNTO 0);  -- int32
  SIGNAL sec1out_1                        : signed(31 DOWNTO 0);  -- int32
  SIGNAL preout                           : signed(31 DOWNTO 0);  -- int32
  SIGNAL dataOut_tmp                      : signed(31 DOWNTO 0);  -- int32

BEGIN
  u_BiquadSection1_inst : Butter_TP_4_6000v1_src_BiquadDF2Section1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dataIn => std_logic_vector(sec0out),  -- int32
              validIn => sec0validout,
              dataOut => sec1out,  -- int32
