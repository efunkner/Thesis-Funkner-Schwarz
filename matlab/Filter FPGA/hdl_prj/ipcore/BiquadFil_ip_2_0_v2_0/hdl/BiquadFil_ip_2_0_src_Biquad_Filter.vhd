-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v5_old_IP_test\BiquadFil_ip_2_0_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_2_0_src_Biquad_Filter
-- Source Path: biquad_test_v5_old_IP_test/Biquad Filtrer/Biquad Filter
-- Hierarchy Level: 1
-- Model version: 1.81
-- 
-- Biquad Filter
...
ENTITY BiquadFil_ip_2_0_src_Biquad_Filter IS
...
END BiquadFil_ip_2_0_src_Biquad_Filter;


ARCHITECTURE rtl OF BiquadFil_ip_2_0_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_2_0_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BiquadFil_ip_2_0_src_BiquadDF2Section1
    USE ENTITY work.BiquadFil_ip_2_0_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : BiquadFil_ip_2_0_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
