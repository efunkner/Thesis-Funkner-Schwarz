-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_2500_v1_src_Biquad_Filter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_2500_v1_src_Biquad_Filter1
...
ENTITY Butter_HP_4_2500_v1_src_Biquad_Filter1 IS
...
END Butter_HP_4_2500_v1_src_Biquad_Filter1;


ARCHITECTURE rtl OF Butter_HP_4_2500_v1_src_Biquad_Filter1 IS

  -- Component Declarations
  COMPONENT Butter_HP_4_2500_v1_src_BiquadDF2Section1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Butter_HP_4_2500_v1_src_BiquadDF2Section1_block
    USE ENTITY work.Butter_HP_4_2500_v1_src_BiquadDF2Section1_block(rtl);
...
BEGIN
  u_BiquadSection1_inst : Butter_HP_4_2500_v1_src_BiquadDF2Section1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
