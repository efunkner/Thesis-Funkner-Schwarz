-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_2500_v1_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_2500_v1_axi4_stream_master
-- Source Path: Butter_HP_4_2500_v1/Butter_HP_4_2500_v1_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Butter_HP_4_2500_v1_axi4_stream_master IS
...
END Butter_HP_4_2500_v1_axi4_stream_master;


ARCHITECTURE rtl OF Butter_HP_4_2500_v1_axi4_stream_master IS

  -- Component Declarations
  COMPONENT Butter_HP_4_2500_v1_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Butter_HP_4_2500_v1_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Butter_HP_4_2500_v1_fifo_data_OUT
    USE ENTITY work.Butter_HP_4_2500_v1_fifo_data_OUT(rtl);

  FOR ALL : Butter_HP_4_2500_v1_fifo_TLAST_OUT
    USE ENTITY work.Butter_HP_4_2500_v1_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_Butter_HP_4_2500_v1_fifo_data_OUT_inst : Butter_HP_4_2500_v1_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Butter_HP_4_2500_v1_fifo_TLAST_OUT_inst : Butter_HP_4_2500_v1_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
