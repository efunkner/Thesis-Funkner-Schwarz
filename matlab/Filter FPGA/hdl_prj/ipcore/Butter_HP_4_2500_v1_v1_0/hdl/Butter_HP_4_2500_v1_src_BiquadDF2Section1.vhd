-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_2500_v1_src_BiquadDF2Section1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_2500_v1_src_BiquadDF2Section1
...
ENTITY Butter_HP_4_2500_v1_src_BiquadDF2Section1 IS
...
END Butter_HP_4_2500_v1_src_BiquadDF2Section1;


ARCHITECTURE rtl OF Butter_HP_4_2500_v1_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  denProd2 <= to_signed(-838515853, 32) * state2;
  ...
  denProd1 <= to_signed(1810774409, 32) * state1;
  ...
  numProd1 <= to_signed(930758022, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-1861516043, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(930758022, 32) * numPrePipe3;
