-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\HP_Butter_2_400Hz_fix32_16.vhd
-- Created: 2025-06-23 16:14:53
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: HP_Butter_2_400Hz_fix32_16
-- Source Path: HP_Butter_2_400Hz_fix32_16
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HP_Butter_2_400Hz_fix32_16 IS
...
END HP_Butter_2_400Hz_fix32_16;


ARCHITECTURE rtl OF HP_Butter_2_400Hz_fix32_16 IS

  -- Component Declarations
  COMPONENT HP_Butter_2_400Hz_fix32_16_reset_sync
  ...
  COMPONENT HP_Butter_2_400Hz_fix32_16_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT HP_Butter_2_400Hz_fix32_16_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT HP_Butter_2_400Hz_fix32_16_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : HP_Butter_2_400Hz_fix32_16_reset_sync
    USE ENTITY work.HP_Butter_2_400Hz_fix32_16_reset_sync(rtl);

  FOR ALL : HP_Butter_2_400Hz_fix32_16_axi4_stream_slave
    USE ENTITY work.HP_Butter_2_400Hz_fix32_16_axi4_stream_slave(rtl);

  FOR ALL : HP_Butter_2_400Hz_fix32_16_dut
    USE ENTITY work.HP_Butter_2_400Hz_fix32_16_dut(rtl);

  FOR ALL : HP_Butter_2_400Hz_fix32_16_axi4_stream_master
    USE ENTITY work.HP_Butter_2_400Hz_fix32_16_axi4_stream_master(rtl);
...
BEGIN
  u_HP_Butter_2_400Hz_fix32_16_reset_sync_inst : HP_Butter_2_400Hz_fix32_16_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_HP_Butter_2_400Hz_fix32_16_axi4_stream_slave_inst : HP_Butter_2_400Hz_fix32_16_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_HP_Butter_2_400Hz_fix32_16_dut_inst : HP_Butter_2_400Hz_fix32_16_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_HP_Butter_2_400Hz_fix32_16_axi4_stream_master_inst : HP_Butter_2_400Hz_fix32_16_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
