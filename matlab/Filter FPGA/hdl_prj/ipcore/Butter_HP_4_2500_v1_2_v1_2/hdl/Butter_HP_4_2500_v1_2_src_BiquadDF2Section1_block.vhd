-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_2500_v1_2_src_BiquadDF2Section1_block.vhd
-- Created: 2025-06-16 14:33:16
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_2500_v1_2_src_BiquadDF2Section1_block
...
ENTITY Butter_HP_4_2500_v1_2_src_BiquadDF2Section1_block IS
...
END Butter_HP_4_2500_v1_2_src_BiquadDF2Section1_block;


ARCHITECTURE rtl OF Butter_HP_4_2500_v1_2_src_BiquadDF2Section1_block IS
  ...
  SIGNAL denProd2                         : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL denOut                           : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL denProd1                         : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL adder_add_cast                   : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL adder_add_cast_1                 : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL denSum2                          : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL adder_add_cast_2                 : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL denSum1                          : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL numPrePipe1                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd1                         : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL numPostPipe1                     : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL numPostPipe1Dly                  : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL numPrePipe2                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd2                         : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL numPostPipe2                     : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL numPrePipe3                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd3                         : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL numPostPipe3                     : signed(63 DOWNTO 0);  -- sfix64_En32
  SIGNAL adder_add_cast_3                 : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL adder_add_cast_4                 : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL numSum2                          : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL numSum2Dly                       : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL adder_add_cast_5                 : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL numSum1                          : signed(66 DOWNTO 0);  -- sfix67_En32
  SIGNAL numSumReg_1                      : signed(66 DOWNTO 0);  -- sfix67_En32
...
BEGIN
  ...
  denProd2 <= to_signed(-35524, 32) * state2;
  ...
  numProd1 <= to_signed(49189, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-98378, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(49189, 32) * numPrePipe3;
  ...
  convertOut <= numSumReg_1(47 DOWNTO 16);
