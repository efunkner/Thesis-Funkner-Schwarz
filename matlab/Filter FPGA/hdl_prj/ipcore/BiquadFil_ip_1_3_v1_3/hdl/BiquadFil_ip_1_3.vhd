-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_1_3
-- Source Path: BiquadFil_ip_1_3
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END BiquadFil_ip_1_3;


ARCHITECTURE rtl OF BiquadFil_ip_1_3 IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_1_3_reset_sync
  ...
  COMPONENT BiquadFil_ip_1_3_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT BiquadFil_ip_1_3_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT BiquadFil_ip_1_3_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BiquadFil_ip_1_3_reset_sync
    USE ENTITY work.BiquadFil_ip_1_3_reset_sync(rtl);

  FOR ALL : BiquadFil_ip_1_3_axi4_stream_slave
    USE ENTITY work.BiquadFil_ip_1_3_axi4_stream_slave(rtl);

  FOR ALL : BiquadFil_ip_1_3_dut
    USE ENTITY work.BiquadFil_ip_1_3_dut(rtl);

  FOR ALL : BiquadFil_ip_1_3_axi4_stream_master
    USE ENTITY work.BiquadFil_ip_1_3_axi4_stream_master(rtl);
...
BEGIN
  u_BiquadFil_ip_1_3_reset_sync_inst : BiquadFil_ip_1_3_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_BiquadFil_ip_1_3_axi4_stream_slave_inst : BiquadFil_ip_1_3_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_BiquadFil_ip_1_3_dut_inst : BiquadFil_ip_1_3_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_BiquadFil_ip_1_3_axi4_stream_master_inst : BiquadFil_ip_1_3_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
