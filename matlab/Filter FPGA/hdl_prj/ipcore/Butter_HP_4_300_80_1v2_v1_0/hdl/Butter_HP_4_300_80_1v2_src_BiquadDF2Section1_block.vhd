-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_300_80_1v2_src_BiquadDF2Section1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_300_80_1v2_src_BiquadDF2Section1_block
...
ENTITY Butter_HP_4_300_80_1v2_src_BiquadDF2Section1_block IS
...
END Butter_HP_4_300_80_1v2_src_BiquadDF2Section1_block;


ARCHITECTURE rtl OF Butter_HP_4_300_80_1v2_src_BiquadDF2Section1_block IS
...
BEGIN
  ...
  denProd2 <= to_signed(-998576076, 32) * state2;
  ...
  denProd1 <= to_signed(2070720218, 32) * state1;
  ...
  numProd1 <= to_signed(1035759530, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-2071519059, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(1035759530, 32) * numPrePipe3;
