-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v5_old_IP_test\BiquadFil_ip_2_1_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_2_1_addr_decoder
-- Source Path: BiquadFil_ip_2_1/BiquadFil_ip_2_1_axi_lite/BiquadFil_ip_2_1_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_2_1_addr_decoder IS
...
END BiquadFil_ip_2_1_addr_decoder;


ARCHITECTURE rtl OF BiquadFil_ip_2_1_addr_decoder IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        data_reg_packet_size_axi4_stream_master_1_1 <= to_unsigned(16777216, 32);
