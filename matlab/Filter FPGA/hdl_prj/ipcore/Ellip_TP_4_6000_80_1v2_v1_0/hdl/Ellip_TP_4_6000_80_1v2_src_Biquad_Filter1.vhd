-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Ellip_TP_4_6000_80_1v2_src_Biquad_Filter1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Ellip_TP_4_6000_80_1v2_src_Biquad_Filter1
...
ENTITY Ellip_TP_4_6000_80_1v2_src_Biquad_Filter1 IS
...
END Ellip_TP_4_6000_80_1v2_src_Biquad_Filter1;


ARCHITECTURE rtl OF Ellip_TP_4_6000_80_1v2_src_Biquad_Filter1 IS

  -- Component Declarations
  COMPONENT Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block
    USE ENTITY work.Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block(rtl);
...
BEGIN
  u_BiquadSection1_inst : Ellip_TP_4_6000_80_1v2_src_BiquadDF2Section1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
