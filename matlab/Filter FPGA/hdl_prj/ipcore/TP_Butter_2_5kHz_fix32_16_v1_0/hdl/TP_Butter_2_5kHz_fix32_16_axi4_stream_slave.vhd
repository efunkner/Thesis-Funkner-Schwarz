-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\TP_Butter_2_5kHz_fix32_16_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: TP_Butter_2_5kHz_fix32_16_axi4_stream_slave
-- Source Path: TP_Butter_2_5kHz_fix32_16/TP_Butter_2_5kHz_fix32_16_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY TP_Butter_2_5kHz_fix32_16_axi4_stream_slave IS
...
END TP_Butter_2_5kHz_fix32_16_axi4_stream_slave;


ARCHITECTURE rtl OF TP_Butter_2_5kHz_fix32_16_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT TP_Butter_2_5kHz_fix32_16_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : TP_Butter_2_5kHz_fix32_16_fifo_data
    USE ENTITY work.TP_Butter_2_5kHz_fix32_16_fifo_data(rtl);
...
BEGIN
  u_TP_Butter_2_5kHz_fix32_16_fifo_data_inst : TP_Butter_2_5kHz_fix32_16_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
