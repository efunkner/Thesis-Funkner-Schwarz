-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_1_4_src_BiquadDF2Section1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_1_4_src_BiquadDF2Section1
-- Source Path: biquad_test_v4_old_IP_test/Biquad Filtrer/Biquad Filter/BiquadDF2Section1
-- Hierarchy Level: 2
-- Model version: 1.74
-- 
-- -------------------------------------------------------------
...
ENTITY BiquadFil_ip_1_4_src_BiquadDF2Section1 IS
...
END BiquadFil_ip_1_4_src_BiquadDF2Section1;


ARCHITECTURE rtl OF BiquadFil_ip_1_4_src_BiquadDF2Section1 IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_10_0 = '1' AND inValidReg = '1' THEN
        state2 <= state1;
      END IF;
    END IF;
