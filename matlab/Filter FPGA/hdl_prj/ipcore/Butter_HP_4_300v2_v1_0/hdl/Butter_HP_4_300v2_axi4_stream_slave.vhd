-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Butter_HP_4_300v2_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Butter_HP_4_300v2_axi4_stream_slave
-- Source Path: Butter_HP_4_300v2/Butter_HP_4_300v2_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Butter_HP_4_300v2_axi4_stream_slave IS
...
END Butter_HP_4_300v2_axi4_stream_slave;


ARCHITECTURE rtl OF Butter_HP_4_300v2_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT Butter_HP_4_300v2_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Butter_HP_4_300v2_fifo_data
    USE ENTITY work.Butter_HP_4_300v2_fifo_data(rtl);
...
BEGIN
  u_Butter_HP_4_300v2_fifo_data_inst : Butter_HP_4_300v2_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
