-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
-- Source Path: LP_Butter_2_1kHz_fix32_16_v2/LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave IS
...
END LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave;


ARCHITECTURE rtl OF LP_Butter_2_1kHz_fix32_16_v2_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT LP_Butter_2_1kHz_fix32_16_v2_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LP_Butter_2_1kHz_fix32_16_v2_fifo_data
    USE ENTITY work.LP_Butter_2_1kHz_fix32_16_v2_fifo_data(rtl);
...
BEGIN
  u_LP_Butter_2_1kHz_fix32_16_v2_fifo_data_inst : LP_Butter_2_1kHz_fix32_16_v2_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
