-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v7_IP\Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1
...
ENTITY Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1 IS
...
END Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1;


ARCHITECTURE rtl OF Ellip_HP_4_300_80_1v2_src_BiquadDF2Section1 IS
  ...
  SIGNAL numProd1                         : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL numPostPipe1                     : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL numPostPipe1Dly                  : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL numPrePipe2                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd2                         : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL numPostPipe2                     : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL numPrePipe3                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL numProd3                         : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL numPostPipe3                     : signed(63 DOWNTO 0);  -- sfix64_En41
  SIGNAL adder_add_cast_3                 : signed(66 DOWNTO 0);  -- sfix67_En41
  SIGNAL adder_add_cast_4                 : signed(66 DOWNTO 0);  -- sfix67_En41
  SIGNAL numSum2                          : signed(66 DOWNTO 0);  -- sfix67_En41
  SIGNAL numSum2Dly                       : signed(66 DOWNTO 0);  -- sfix67_En41
  SIGNAL adder_add_cast_5                 : signed(66 DOWNTO 0);  -- sfix67_En41
  SIGNAL numSum1                          : signed(66 DOWNTO 0);  -- sfix67_En41
  SIGNAL numSumReg_1                      : signed(66 DOWNTO 0);  -- sfix67_En41
...
BEGIN
  ...
  denProd2 <= to_signed(-978446100, 32) * state2;
  ...
  denProd1 <= to_signed(2046680827, 32) * state1;
  ...
  numProd1 <= to_signed(561175396, 32) * numPrePipe1;
  ...
  numProd2 <= to_signed(-1122343588, 32) * numPrePipe2;
  ...
  numProd3 <= to_signed(561175396, 32) * numPrePipe3;
  ...
  convertOut <= numSumReg_1(56 DOWNTO 25);
