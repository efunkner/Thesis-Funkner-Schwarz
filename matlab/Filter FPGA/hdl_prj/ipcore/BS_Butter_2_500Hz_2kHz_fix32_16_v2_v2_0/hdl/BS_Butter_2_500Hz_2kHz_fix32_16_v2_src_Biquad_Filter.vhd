-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_Filter_v8_IP_2\BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_Biquad_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_Biquad_Filter
...
ENTITY BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_Biquad_Filter IS
...
END BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_Biquad_Filter;


ARCHITECTURE rtl OF BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_Biquad_Filter IS

  -- Component Declarations
  COMPONENT BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1
    USE ENTITY work.BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1(rtl);
...
BEGIN
  u_BiquadSection1_inst : BS_Butter_2_500Hz_2kHz_fix32_16_v2_src_BiquadDF2Section1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
