-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_fifo_TLAST_OUT
-- Source Path: BiquadFil_ip/BiquadFil_ip_axi4_stream_master/BiquadFil_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_fifo_TLAST_OUT IS
...
END BiquadFil_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF BiquadFil_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : BiquadFil_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.BiquadFil_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_BiquadFil_ip_fifo_TLAST_OUT_classic_ram_singlebit : BiquadFil_ip_SimpleDualPortRAM_singlebit
