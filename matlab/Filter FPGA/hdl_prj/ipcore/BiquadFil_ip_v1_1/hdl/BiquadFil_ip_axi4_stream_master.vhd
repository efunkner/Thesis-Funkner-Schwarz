-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\biquad_test_v4_old_IP_test\BiquadFil_ip_axi4_stream_master.vhd
-- Created: 2025-05-22 11:27:50
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BiquadFil_ip_axi4_stream_master
-- Source Path: BiquadFil_ip/BiquadFil_ip_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BiquadFil_ip_axi4_stream_master IS
...
END BiquadFil_ip_axi4_stream_master;


ARCHITECTURE rtl OF BiquadFil_ip_axi4_stream_master IS

  -- Component Declarations
  COMPONENT BiquadFil_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BiquadFil_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BiquadFil_ip_fifo_data_OUT
    USE ENTITY work.BiquadFil_ip_fifo_data_OUT(rtl);

  FOR ALL : BiquadFil_ip_fifo_TLAST_OUT
    USE ENTITY work.BiquadFil_ip_fifo_TLAST_OUT(rtl);
  ...
  SIGNAL multirate_int_delay_port_tready_reg : std_logic_vector(58 DOWNTO 0);  -- ufix1 [59]
...
BEGIN
  u_BiquadFil_ip_fifo_data_OUT_inst : BiquadFil_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_BiquadFil_ip_fifo_TLAST_OUT_inst : BiquadFil_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        IF count_check_master >= to_unsigned(16#3B#, 8) THEN 
          count_check_master <= to_unsigned(16#00#, 8);
        ELSE 
  ...
  count_match_master <= '1' WHEN count_check_master = to_unsigned(16#3B#, 8) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        multirate_int_delay_port_tready_reg(58 DOWNTO 1) <= multirate_int_delay_port_tready_reg(57 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS multirate_int_delay_port_tready_process;

  fifo_port_tready <= multirate_int_delay_port_tready_reg(58);
