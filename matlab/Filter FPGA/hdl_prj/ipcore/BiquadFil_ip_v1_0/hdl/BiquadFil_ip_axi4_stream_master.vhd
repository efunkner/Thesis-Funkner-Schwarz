...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        IF count_check_master >= to_unsigned(16#01#, 8) THEN 
          count_check_master <= to_unsigned(16#00#, 8);
        ELSE 
  ...
  count_match_master <= '1' WHEN count_check_master = to_unsigned(16#01#, 8) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        fifo_port_tready <= '0';
      ELSIF enb = '1' THEN
        fifo_port_tready <= AXI4_Stream_Master_TREADY;
      END IF;
    END IF;
